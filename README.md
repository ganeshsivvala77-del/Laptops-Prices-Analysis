...
Which factors have the strongest impact on laptop pricing?

How do discounts affect the final selling price?
...
Processed and structured product specifications into analyzable features

Conducted exploratory data analysis to identify trends and patterns

Analyzed the relationship between pricing, discounts, and customer ratings
...
Laptops with higher RAM and SSD storage are priced higher

Discount strategies vary notably across brands
